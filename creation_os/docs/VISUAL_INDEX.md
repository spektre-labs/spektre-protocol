...
Paths are relative to the **repository root** (`creation-os/` public tree or `creation_os/` kernel tree — same `docs/assets/` layout under `docs/`).

## Mermaid

Full figures + Mermaid live in the portable tree: [README.md](../../creation-os/README.md) (monorepo relative path).
