...
For the **standalone teaching tree** (`creation-os/`), the same template lives at [`creation-os/docs/REPRO_BUNDLE_TEMPLATE.md`](../../creation-os/docs/REPRO_BUNDLE_TEMPLATE.md).
...
**Note:** throughput is **host-dependent**; ops/RAM ratios in the public README are **arithmetic** for the stated `D` and encodings.
