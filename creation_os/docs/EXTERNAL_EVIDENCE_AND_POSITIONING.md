...
## 6. Related in-repo brief (strategy)

**[HDC_VSA_ENGINEERING_SUPERIORITY.md](HDC_VSA_ENGINEERING_SUPERIORITY.md)** — Ma & Jiao (2022), Aygun et al. (2023), AIR HDC classification review (2025), Yeung et al. (2025), FAISS Hamming note, mapped to Creation OS evidence classes.
