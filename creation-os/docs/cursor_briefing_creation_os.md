...
Repository: [spektre-labs/creation-os](https://github.com/spektre-labs/creation-os). **One command:** `make all`. **One file to read first:** `creation_os_v2.c`. **Feature map (v2 + v6–v10):** [FEATURES_AND_STANDALONE_BUILDS.md](FEATURES_AND_STANDALONE_BUILDS.md). **Living Kernel (v6):** [`creation_os_v6.c`](../creation_os_v6.c) + [LIVING_KERNEL_V6.md](LIVING_KERNEL_V6.md); **`make check-v6`** when editing it. **Hallucination Killer (v7):** [`creation_os_v7.c`](../creation_os_v7.c) + [HALLUCINATION_KILLER_V7.md](HALLUCINATION_KILLER_V7.md); **`make check-v7`** when editing it. **Parameters in Silicon (v9):** [`creation_os_v9.c`](../creation_os_v9.c) + [PARAMETERS_IN_SILICON_V9.md](PARAMETERS_IN_SILICON_V9.md); **`make check-v9`** when editing it. **The Real Mind (v10):** [`creation_os_v10.c`](../creation_os_v10.c) + [THE_REAL_MIND_V10.md](THE_REAL_MIND_V10.md); **`make check-v10`** when editing it.
